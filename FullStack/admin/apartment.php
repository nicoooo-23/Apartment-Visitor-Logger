...
<tr>
    ...
    <form method="POST">
        ...
        <td>
            ...
            <!-- Delete button -->
            <a href="?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this apartment?');" style="color: red; text-decoration: none; margin-left: 10px;">
                Delete
            </a>
        </td>
    </form>
